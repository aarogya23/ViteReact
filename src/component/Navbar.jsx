...
const Navbar = () => {
  ...
  // Check if the current route is '/home', '/contact', '/about', '/learn-categories', or '/tree'
  ...
  const isRecursion = location.pathname === '/recursion';
  return (
    <div>
  ...
  <li className="nav-item">
    <Link to="/login" className="nav-link">Login</Link>
      ...
      {/* Only render it if the current page is not Home, About, Contact, Learn, or Tree */}
      {!isHomePage && !isContactPage && !isAboutPage && !isLearnPage && !isTreePage && !islogin && !isRegister && !isRecursion && (
